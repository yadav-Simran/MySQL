...
4. Alter usp_getStudentData with additional input/output parameters to retrieve the
details of the faculties of CSE department who teaches DBMS.
5. Execute the stored procedure and print the output parameters and return value after
execution.
6. Encrypt the procedure usp_getStudentData and try to alter the procedure input
parameters with default input parameter values.
*/
